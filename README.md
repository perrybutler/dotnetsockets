...
Client/server chat/packet engine using asynchronous .NET sockets via an Event-based Asynchronous Pattern (EAP) [[1]](#references) on top of an IAsyncResult Pattern [[2]](#references) with thread pools (I/O completion ports) for the *maximum concurrency, capacity, performance and scalability* [[2]](#references) [[3]](#references) [[6]](#references).
